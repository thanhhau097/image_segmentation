"""
Only checked General Dice Loss
"""
...
class GeneralizedDiceLossWrapper():
    def __init__(self):
        self.__name__ = 'GDL'
    ...
    def __call__(self, output, target, eps=1e-5, weight_type='square'):
        return GeneralizedDiceLoss(output, target, eps=1e-5, weight_type='square')
